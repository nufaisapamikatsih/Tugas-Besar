	...
	function RenderOtherOptions() {
		...
		$options = &$this->OtherOptions;
			...
			foreach ($this->CustomActions as $action => $name) {
				...
				$item->Body = "<a class=\"ewAction ewCustomAction\" href=\"\" onclick=\"ew_SubmitSelected(document.fuserlist, '" . ew_CurrentUrl() . "', null, '" . $action . "');return false;\">" . $name . "</a>";
			}
...
<?php
	...
	if ($user->CurrentAction == "" && $user_list->TotalRecs == 0) {
		if (!$Security->CanList())
			$user_list->setWarningMessage($Language->Phrase("NoPermission"));
...
<?php if ($user->id->Visible) { // id ?>
	<?php if ($user->SortUrl($user->id) == "") { ?>
		<th data-name="id"><div id="elh_user_id" class="user_id"><div class="ewTableHeaderCaption"><?php echo $user->id->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="id"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $user->SortUrl($user->id) ?>',1);"><div id="elh_user_id" class="user_id">
...
<?php if ($user->username->Visible) { // username ?>
	<?php if ($user->SortUrl($user->username) == "") { ?>
		<th data-name="username"><div id="elh_user_username" class="user_username"><div class="ewTableHeaderCaption"><?php echo $user->username->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="username"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $user->SortUrl($user->username) ?>',1);"><div id="elh_user_username" class="user_username">
...
<?php if ($user->userlevel->Visible) { // userlevel ?>
	<?php if ($user->SortUrl($user->userlevel) == "") { ?>
		<th data-name="userlevel"><div id="elh_user_userlevel" class="user_userlevel"><div class="ewTableHeaderCaption"><?php echo $user->userlevel->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="userlevel"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $user->SortUrl($user->userlevel) ?>',1);"><div id="elh_user_userlevel" class="user_userlevel">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $user->userlevel->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($user->userlevel->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($user->userlevel->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php
...
<?php echo $user->password->ListViewValue() ?></span>
	...
	<?php } ?>
	<?php if ($user->userlevel->Visible) { // userlevel ?>
		<td data-name="userlevel"<?php echo $user->userlevel->CellAttributes() ?>>
<span<?php echo $user->userlevel->ViewAttributes() ?>>
<?php echo $user->userlevel->ListViewValue() ?></span>
</td>
	<?php } ?>
<?php

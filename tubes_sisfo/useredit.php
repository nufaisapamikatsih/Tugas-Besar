...
<?php if ($user->id->Visible) { // id ?>
	<div id="r_id" class="form-group">
		<label id="elh_user_id" class="col-sm-2 control-label ewLabel"><?php echo $user->id->FldCaption() ?></label>
		<div class="col-sm-10"><div<?php echo $user->id->CellAttributes() ?>>
<span id="el_user_id">
<span<?php echo $user->id->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $user->id->EditValue ?></p></span>
</span>
<input type="hidden" data-field="x_id" name="x_id" id="x_id" value="<?php echo ew_HtmlEncode($user->id->CurrentValue) ?>">

...
$fixed_asset_assign_view = NULL; // Initialize page object first

class cfixed_asset_assign_view extends cfixed_asset_assign {
	...
	// Page object name
	var $PageObjName = 'fixed_asset_assign_view';
	...
	function __construct() {
		...
		$KeyUrl = "";
		if (@$_GET["faa_id"] <> "") {
			$this->RecKey["faa_id"] = $_GET["faa_id"];
			$KeyUrl .= "&amp;faa_id=" . urlencode($this->RecKey["faa_id"]);
		}
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["faa_id"] <> "") {
				...
				$this->RecKey["faa_id"] = $this->faa_id->QueryStringValue;
			} else {
				$sReturnUrl = "fixed_asset_assignlist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "fixed_asset_assignlist.php"; // No matching record, return to list
					}
			}
		} else {
			$sReturnUrl = "fixed_asset_assignlist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($fixed_asset_assign_view)) $fixed_asset_assign_view = new cfixed_asset_assign_view();

// Page init
$fixed_asset_assign_view->Page_Init();

// Page main
$fixed_asset_assign_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$fixed_asset_assign_view->Page_Render();
?>
<?php include_once $EW_RELATIVE_PATH . "header.php" ?>
<script type="text/javascript">

// Page object
var fixed_asset_assign_view = new ew_Page("fixed_asset_assign_view");
fixed_asset_assign_view.PageID = "view"; // Page ID
var EW_PAGE_ID = fixed_asset_assign_view.PageID; // For backward compatibility

// Form object
var ffixed_asset_assignview = new ew_Form("ffixed_asset_assignview");

// Form_CustomValidate event
ffixed_asset_assignview.Form_CustomValidate = 
...
ffixed_asset_assignview.ValidateRequired = true;
<?php } else { ?>
ffixed_asset_assignview.ValidateRequired = false; 
<?php } ?>
...
<?php $fixed_asset_assign_view->ExportOptions->Render("body") ?>
<?php
	foreach ($fixed_asset_assign_view->OtherOptions as &$option)
		$option->Render("body");
?>
<?php echo $Language->SelectionForm(); ?>
<div class="clearfix"></div>
</div>
<?php $fixed_asset_assign_view->ShowPageHeader(); ?>
<?php
$fixed_asset_assign_view->ShowMessage();
?>
<form name="ffixed_asset_assignview" id="ffixed_asset_assignview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($fixed_asset_assign_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $fixed_asset_assign_view->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="fixed_asset_assign">
<table class="table table-bordered table-striped ewViewTable">
<?php if ($fixed_asset_assign->faa_id->Visible) { // faa_id ?>
	<tr id="r_faa_id">
		<td><span id="elh_fixed_asset_assign_faa_id"><?php echo $fixed_asset_assign->faa_id->FldCaption() ?></span></td>
		<td<?php echo $fixed_asset_assign->faa_id->CellAttributes() ?>>
<span id="el_fixed_asset_assign_faa_id" class="form-group">
<span<?php echo $fixed_asset_assign->faa_id->ViewAttributes() ?>>
<?php echo $fixed_asset_assign->faa_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($fixed_asset_assign->fk_faa->Visible) { // fk_faa ?>
	<tr id="r_fk_faa">
		<td><span id="elh_fixed_asset_assign_fk_faa"><?php echo $fixed_asset_assign->fk_faa->FldCaption() ?></span></td>
		<td<?php echo $fixed_asset_assign->fk_faa->CellAttributes() ?>>
<span id="el_fixed_asset_assign_fk_faa" class="form-group">
<span<?php echo $fixed_asset_assign->fk_faa->ViewAttributes() ?>>
<?php echo $fixed_asset_assign->fk_faa->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($fixed_asset_assign->fk_faa2->Visible) { // fk_faa2 ?>
	<tr id="r_fk_faa2">
		<td><span id="elh_fixed_asset_assign_fk_faa2"><?php echo $fixed_asset_assign->fk_faa2->FldCaption() ?></span></td>
		<td<?php echo $fixed_asset_assign->fk_faa2->CellAttributes() ?>>
<span id="el_fixed_asset_assign_fk_faa2" class="form-group">
<span<?php echo $fixed_asset_assign->fk_faa2->ViewAttributes() ?>>
<?php echo $fixed_asset_assign->fk_faa2->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($fixed_asset_assign->from_date->Visible) { // from_date ?>
	<tr id="r_from_date">
		<td><span id="elh_fixed_asset_assign_from_date"><?php echo $fixed_asset_assign->from_date->FldCaption() ?></span></td>
		<td<?php echo $fixed_asset_assign->from_date->CellAttributes() ?>>
<span id="el_fixed_asset_assign_from_date" class="form-group">
<span<?php echo $fixed_asset_assign->from_date->ViewAttributes() ?>>
<?php echo $fixed_asset_assign->from_date->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($fixed_asset_assign->thru_date->Visible) { // thru_date ?>
	<tr id="r_thru_date">
		<td><span id="elh_fixed_asset_assign_thru_date"><?php echo $fixed_asset_assign->thru_date->FldCaption() ?></span></td>
		<td<?php echo $fixed_asset_assign->thru_date->CellAttributes() ?>>
<span id="el_fixed_asset_assign_thru_date" class="form-group">
<span<?php echo $fixed_asset_assign->thru_date->ViewAttributes() ?>>
<?php echo $fixed_asset_assign->thru_date->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($fixed_asset_assign->comm->Visible) { // comm ?>
	<tr id="r_comm">
		<td><span id="elh_fixed_asset_assign_comm"><?php echo $fixed_asset_assign->comm->FldCaption() ?></span></td>
		<td<?php echo $fixed_asset_assign->comm->CellAttributes() ?>>
<span id="el_fixed_asset_assign_comm" class="form-group">
<span<?php echo $fixed_asset_assign->comm->ViewAttributes() ?>>
<?php echo $fixed_asset_assign->comm->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<script type="text/javascript">
ffixed_asset_assignview.Init();
</script>
<?php
$fixed_asset_assign_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$fixed_asset_assign_view->Page_Terminate();
?>

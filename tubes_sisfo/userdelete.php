...
<?php if ($user->id->Visible) { // id ?>
		<th><span id="elh_user_id" class="user_id"><?php echo $user->id->FldCaption() ?></span></th>
<?php } ?>
<?php if ($user->username->Visible) { // username ?>
		<th><span id="elh_user_username" class="user_username"><?php echo $user->username->FldCaption() ?></span></th>
<?php } ?>
...
<?php if ($user->userlevel->Visible) { // userlevel ?>
		<th><span id="elh_user_userlevel" class="user_userlevel"><?php echo $user->userlevel->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
...
<span id="el<?php echo $user_delete->RowCnt ?>_user_id" class="form-group user_id">
...
<span id="el<?php echo $user_delete->RowCnt ?>_user_username" class="form-group user_username">
...
<span id="el<?php echo $user_delete->RowCnt ?>_user_password" class="form-group user_password">
...
<?php } ?>
<?php if ($user->userlevel->Visible) { // userlevel ?>
		<td<?php echo $user->userlevel->CellAttributes() ?>>
<span id="el<?php echo $user_delete->RowCnt ?>_user_userlevel" class="form-group user_userlevel">

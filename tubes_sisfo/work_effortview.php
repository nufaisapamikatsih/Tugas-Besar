...
$work_effort_view = NULL; // Initialize page object first

class cwork_effort_view extends cwork_effort {
	...
	// Page object name
	var $PageObjName = 'work_effort_view';
	...
	function __construct() {
		...
		$KeyUrl = "";
		if (@$_GET["we_id"] <> "") {
			$this->RecKey["we_id"] = $_GET["we_id"];
			$KeyUrl .= "&amp;we_id=" . urlencode($this->RecKey["we_id"]);
		}
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["we_id"] <> "") {
				...
				$this->RecKey["we_id"] = $this->we_id->QueryStringValue;
			} else {
				$sReturnUrl = "work_effortlist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "work_effortlist.php"; // No matching record, return to list
					}
			}
		} else {
			$sReturnUrl = "work_effortlist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($work_effort_view)) $work_effort_view = new cwork_effort_view();

// Page init
$work_effort_view->Page_Init();

// Page main
$work_effort_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$work_effort_view->Page_Render();
?>
<?php include_once $EW_RELATIVE_PATH . "header.php" ?>
<script type="text/javascript">

// Page object
var work_effort_view = new ew_Page("work_effort_view");
work_effort_view.PageID = "view"; // Page ID
var EW_PAGE_ID = work_effort_view.PageID; // For backward compatibility

// Form object
var fwork_effortview = new ew_Form("fwork_effortview");

// Form_CustomValidate event
fwork_effortview.Form_CustomValidate = 
...
fwork_effortview.ValidateRequired = true;
<?php } else { ?>
fwork_effortview.ValidateRequired = false; 
<?php } ?>
...
<?php $work_effort_view->ExportOptions->Render("body") ?>
<?php
	foreach ($work_effort_view->OtherOptions as &$option)
		$option->Render("body");
?>
<?php echo $Language->SelectionForm(); ?>
<div class="clearfix"></div>
</div>
<?php $work_effort_view->ShowPageHeader(); ?>
<?php
$work_effort_view->ShowMessage();
?>
<form name="fwork_effortview" id="fwork_effortview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($work_effort_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $work_effort_view->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="work_effort">
<table class="table table-bordered table-striped ewViewTable">
<?php if ($work_effort->we_id->Visible) { // we_id ?>
	<tr id="r_we_id">
		<td><span id="elh_work_effort_we_id"><?php echo $work_effort->we_id->FldCaption() ?></span></td>
		<td<?php echo $work_effort->we_id->CellAttributes() ?>>
<span id="el_work_effort_we_id" class="form-group">
<span<?php echo $work_effort->we_id->ViewAttributes() ?>>
<?php echo $work_effort->we_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($work_effort->fk_we->Visible) { // fk_we ?>
	<tr id="r_fk_we">
		<td><span id="elh_work_effort_fk_we"><?php echo $work_effort->fk_we->FldCaption() ?></span></td>
		<td<?php echo $work_effort->fk_we->CellAttributes() ?>>
<span id="el_work_effort_fk_we" class="form-group">
<span<?php echo $work_effort->fk_we->ViewAttributes() ?>>
<?php echo $work_effort->fk_we->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($work_effort->name->Visible) { // name ?>
	<tr id="r_name">
		<td><span id="elh_work_effort_name"><?php echo $work_effort->name->FldCaption() ?></span></td>
		<td<?php echo $work_effort->name->CellAttributes() ?>>
<span id="el_work_effort_name" class="form-group">
<span<?php echo $work_effort->name->ViewAttributes() ?>>
<?php echo $work_effort->name->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($work_effort->des->Visible) { // des ?>
	<tr id="r_des">
		<td><span id="elh_work_effort_des"><?php echo $work_effort->des->FldCaption() ?></span></td>
		<td<?php echo $work_effort->des->CellAttributes() ?>>
<span id="el_work_effort_des" class="form-group">
<span<?php echo $work_effort->des->ViewAttributes() ?>>
<?php echo $work_effort->des->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($work_effort->start_date->Visible) { // start_date ?>
	<tr id="r_start_date">
		<td><span id="elh_work_effort_start_date"><?php echo $work_effort->start_date->FldCaption() ?></span></td>
		<td<?php echo $work_effort->start_date->CellAttributes() ?>>
<span id="el_work_effort_start_date" class="form-group">
<span<?php echo $work_effort->start_date->ViewAttributes() ?>>
<?php echo $work_effort->start_date->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($work_effort->completion_date->Visible) { // completion_date ?>
	<tr id="r_completion_date">
		<td><span id="elh_work_effort_completion_date"><?php echo $work_effort->completion_date->FldCaption() ?></span></td>
		<td<?php echo $work_effort->completion_date->CellAttributes() ?>>
<span id="el_work_effort_completion_date" class="form-group">
<span<?php echo $work_effort->completion_date->ViewAttributes() ?>>
<?php echo $work_effort->completion_date->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($work_effort->estimated_hours->Visible) { // estimated_hours ?>
	<tr id="r_estimated_hours">
		<td><span id="elh_work_effort_estimated_hours"><?php echo $work_effort->estimated_hours->FldCaption() ?></span></td>
		<td<?php echo $work_effort->estimated_hours->CellAttributes() ?>>
<span id="el_work_effort_estimated_hours" class="form-group">
<span<?php echo $work_effort->estimated_hours->ViewAttributes() ?>>
<?php echo $work_effort->estimated_hours->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<script type="text/javascript">
fwork_effortview.Init();
</script>
<?php
$work_effort_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$work_effort_view->Page_Terminate();
?>

...
$we_from_work_req_edit = NULL; // Initialize page object first

class cwe_from_work_req_edit extends cwe_from_work_req {
	...
	// Page object name
	var $PageObjName = 'we_from_work_req_edit';
	...
	function Page_Main() {
		...
		// Check if valid key
		if ($this->wfwr_id->CurrentValue == "")
			$this->Page_Terminate("we_from_work_reqlist.php"); // Invalid key, return to list
	...
	function EditRow() {
		...
		if ($rs->EOF) {
			...
			$this->fk_wfwr->SetDbValueDef($rsnew, $this->fk_wfwr->CurrentValue, NULL, $this->fk_wfwr->ReadOnly);

			// fk_wfwr2
			$this->fk_wfwr2->SetDbValueDef($rsnew, $this->fk_wfwr2->CurrentValue, NULL, $this->fk_wfwr2->ReadOnly);
...
// Create page object
if (!isset($we_from_work_req_edit)) $we_from_work_req_edit = new cwe_from_work_req_edit();

// Page init
$we_from_work_req_edit->Page_Init();

// Page main
$we_from_work_req_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$we_from_work_req_edit->Page_Render();
?>
<?php include_once $EW_RELATIVE_PATH . "header.php" ?>
<script type="text/javascript">

// Page object
var we_from_work_req_edit = new ew_Page("we_from_work_req_edit");
we_from_work_req_edit.PageID = "edit"; // Page ID
var EW_PAGE_ID = we_from_work_req_edit.PageID; // For backward compatibility

// Form object
var fwe_from_work_reqedit = new ew_Form("fwe_from_work_reqedit");

// Validate form
fwe_from_work_reqedit.Validate = function() {
...
fwe_from_work_reqedit.Form_CustomValidate = 
...
fwe_from_work_reqedit.ValidateRequired = true;
<?php } else { ?>
fwe_from_work_reqedit.ValidateRequired = false; 
<?php } ?>
...
<?php $we_from_work_req_edit->ShowPageHeader(); ?>
<?php
$we_from_work_req_edit->ShowMessage();
?>
<form name="fwe_from_work_reqedit" id="fwe_from_work_reqedit" class="form-horizontal ewForm ewEditForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($we_from_work_req_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $we_from_work_req_edit->Token ?>">
<?php } ?>
...
<p class="form-control-static"><?php echo $we_from_work_req->wfwr_id->EditValue ?></p></span>
</span>
<input type="hidden" data-field="x_wfwr_id" name="x_wfwr_id" id="x_wfwr_id" value="<?php echo ew_HtmlEncode($we_from_work_req->wfwr_id->CurrentValue) ?>">
...
<script type="text/javascript">
fwe_from_work_reqedit.Init();
</script>
<?php
$we_from_work_req_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$we_from_work_req_edit->Page_Terminate();
?>

...
<?php if ($user->id->Visible) { // id ?>
	<tr id="r_id">
		<td><span id="elh_user_id"><?php echo $user->id->FldCaption() ?></span></td>
		<td<?php echo $user->id->CellAttributes() ?>>
<span id="el_user_id" class="form-group">
...
<?php if ($user->username->Visible) { // username ?>
	<tr id="r_username">
		<td><span id="elh_user_username"><?php echo $user->username->FldCaption() ?></span></td>
		<td<?php echo $user->username->CellAttributes() ?>>
<span id="el_user_username" class="form-group">
...
<span id="el_user_password" class="form-group">
...
<?php if ($user->userlevel->Visible) { // userlevel ?>
	<tr id="r_userlevel">
		<td><span id="elh_user_userlevel"><?php echo $user->userlevel->FldCaption() ?></span></td>
		<td<?php echo $user->userlevel->CellAttributes() ?>>
<span id="el_user_userlevel" class="form-group">
<span<?php echo $user->userlevel->ViewAttributes() ?>>
<?php echo $user->userlevel->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>

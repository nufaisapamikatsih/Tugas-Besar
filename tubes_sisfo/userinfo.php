...
class cuser extends cTable {
	...
	function __construct() {
		...
		// id
		$this->id = new cField('user', 'user', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// username
		$this->username = new cField('user', 'user', 'x_username', 'username', '`username`', '`username`', 200, -1, FALSE, '`username`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		// userlevel
		$this->userlevel = new cField('user', 'user', 'x_userlevel', 'userlevel', '`userlevel`', '`userlevel`', 3, -1, FALSE, '`userlevel`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');

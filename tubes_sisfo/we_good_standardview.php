...
$we_good_standard_view = NULL; // Initialize page object first

class cwe_good_standard_view extends cwe_good_standard {
	...
	// Page object name
	var $PageObjName = 'we_good_standard_view';
	...
	function __construct() {
		...
		$KeyUrl = "";
		if (@$_GET["wegs_id"] <> "") {
			$this->RecKey["wegs_id"] = $_GET["wegs_id"];
			$KeyUrl .= "&amp;wegs_id=" . urlencode($this->RecKey["wegs_id"]);
		}
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["wegs_id"] <> "") {
				...
				$this->RecKey["wegs_id"] = $this->wegs_id->QueryStringValue;
			} else {
				$sReturnUrl = "we_good_standardlist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "we_good_standardlist.php"; // No matching record, return to list
					}
			}
		} else {
			$sReturnUrl = "we_good_standardlist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($we_good_standard_view)) $we_good_standard_view = new cwe_good_standard_view();

// Page init
$we_good_standard_view->Page_Init();

// Page main
$we_good_standard_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$we_good_standard_view->Page_Render();
?>
<?php include_once $EW_RELATIVE_PATH . "header.php" ?>
<script type="text/javascript">

// Page object
var we_good_standard_view = new ew_Page("we_good_standard_view");
we_good_standard_view.PageID = "view"; // Page ID
var EW_PAGE_ID = we_good_standard_view.PageID; // For backward compatibility

// Form object
var fwe_good_standardview = new ew_Form("fwe_good_standardview");

// Form_CustomValidate event
fwe_good_standardview.Form_CustomValidate = 
...
fwe_good_standardview.ValidateRequired = true;
<?php } else { ?>
fwe_good_standardview.ValidateRequired = false; 
<?php } ?>
...
<?php $we_good_standard_view->ExportOptions->Render("body") ?>
<?php
	foreach ($we_good_standard_view->OtherOptions as &$option)
		$option->Render("body");
?>
<?php echo $Language->SelectionForm(); ?>
<div class="clearfix"></div>
</div>
<?php $we_good_standard_view->ShowPageHeader(); ?>
<?php
$we_good_standard_view->ShowMessage();
?>
<form name="fwe_good_standardview" id="fwe_good_standardview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($we_good_standard_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $we_good_standard_view->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="we_good_standard">
<table class="table table-bordered table-striped ewViewTable">
<?php if ($we_good_standard->wegs_id->Visible) { // wegs_id ?>
	<tr id="r_wegs_id">
		<td><span id="elh_we_good_standard_wegs_id"><?php echo $we_good_standard->wegs_id->FldCaption() ?></span></td>
		<td<?php echo $we_good_standard->wegs_id->CellAttributes() ?>>
<span id="el_we_good_standard_wegs_id" class="form-group">
<span<?php echo $we_good_standard->wegs_id->ViewAttributes() ?>>
<?php echo $we_good_standard->wegs_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($we_good_standard->fk_wegs->Visible) { // fk_wegs ?>
	<tr id="r_fk_wegs">
		<td><span id="elh_we_good_standard_fk_wegs"><?php echo $we_good_standard->fk_wegs->FldCaption() ?></span></td>
		<td<?php echo $we_good_standard->fk_wegs->CellAttributes() ?>>
<span id="el_we_good_standard_fk_wegs" class="form-group">
<span<?php echo $we_good_standard->fk_wegs->ViewAttributes() ?>>
<?php echo $we_good_standard->fk_wegs->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($we_good_standard->item->Visible) { // item ?>
	<tr id="r_item">
		<td><span id="elh_we_good_standard_item"><?php echo $we_good_standard->item->FldCaption() ?></span></td>
		<td<?php echo $we_good_standard->item->CellAttributes() ?>>
<span id="el_we_good_standard_item" class="form-group">
<span<?php echo $we_good_standard->item->ViewAttributes() ?>>
<?php echo $we_good_standard->item->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($we_good_standard->est_quantity->Visible) { // est_quantity ?>
	<tr id="r_est_quantity">
		<td><span id="elh_we_good_standard_est_quantity"><?php echo $we_good_standard->est_quantity->FldCaption() ?></span></td>
		<td<?php echo $we_good_standard->est_quantity->CellAttributes() ?>>
<span id="el_we_good_standard_est_quantity" class="form-group">
<span<?php echo $we_good_standard->est_quantity->ViewAttributes() ?>>
<?php echo $we_good_standard->est_quantity->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($we_good_standard->est_cost->Visible) { // est_cost ?>
	<tr id="r_est_cost">
		<td><span id="elh_we_good_standard_est_cost"><?php echo $we_good_standard->est_cost->FldCaption() ?></span></td>
		<td<?php echo $we_good_standard->est_cost->CellAttributes() ?>>
<span id="el_we_good_standard_est_cost" class="form-group">
<span<?php echo $we_good_standard->est_cost->ViewAttributes() ?>>
<?php echo $we_good_standard->est_cost->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<script type="text/javascript">
fwe_good_standardview.Init();
</script>
<?php
$we_good_standard_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$we_good_standard_view->Page_Terminate();
?>

...
$party_skill_data_view = NULL; // Initialize page object first

class cparty_skill_data_view extends cparty_skill_data {
	...
	// Page object name
	var $PageObjName = 'party_skill_data_view';
	...
	function __construct() {
		...
		$KeyUrl = "";
		if (@$_GET["psd_id"] <> "") {
			$this->RecKey["psd_id"] = $_GET["psd_id"];
			$KeyUrl .= "&amp;psd_id=" . urlencode($this->RecKey["psd_id"]);
		}
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["psd_id"] <> "") {
				...
				$this->RecKey["psd_id"] = $this->psd_id->QueryStringValue;
			} else {
				$sReturnUrl = "party_skill_datalist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "party_skill_datalist.php"; // No matching record, return to list
					}
			}
		} else {
			$sReturnUrl = "party_skill_datalist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($party_skill_data_view)) $party_skill_data_view = new cparty_skill_data_view();

// Page init
$party_skill_data_view->Page_Init();

// Page main
$party_skill_data_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$party_skill_data_view->Page_Render();
?>
<?php include_once $EW_RELATIVE_PATH . "header.php" ?>
<script type="text/javascript">

// Page object
var party_skill_data_view = new ew_Page("party_skill_data_view");
party_skill_data_view.PageID = "view"; // Page ID
var EW_PAGE_ID = party_skill_data_view.PageID; // For backward compatibility

// Form object
var fparty_skill_dataview = new ew_Form("fparty_skill_dataview");

// Form_CustomValidate event
fparty_skill_dataview.Form_CustomValidate = 
...
fparty_skill_dataview.ValidateRequired = true;
<?php } else { ?>
fparty_skill_dataview.ValidateRequired = false; 
<?php } ?>
...
<?php $party_skill_data_view->ExportOptions->Render("body") ?>
<?php
	foreach ($party_skill_data_view->OtherOptions as &$option)
		$option->Render("body");
?>
<?php echo $Language->SelectionForm(); ?>
<div class="clearfix"></div>
</div>
<?php $party_skill_data_view->ShowPageHeader(); ?>
<?php
$party_skill_data_view->ShowMessage();
?>
<form name="fparty_skill_dataview" id="fparty_skill_dataview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($party_skill_data_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $party_skill_data_view->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="party_skill_data">
<table class="table table-bordered table-striped ewViewTable">
<?php if ($party_skill_data->psd_id->Visible) { // psd_id ?>
	<tr id="r_psd_id">
		<td><span id="elh_party_skill_data_psd_id"><?php echo $party_skill_data->psd_id->FldCaption() ?></span></td>
		<td<?php echo $party_skill_data->psd_id->CellAttributes() ?>>
<span id="el_party_skill_data_psd_id" class="form-group">
<span<?php echo $party_skill_data->psd_id->ViewAttributes() ?>>
<?php echo $party_skill_data->psd_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($party_skill_data->fk_psd->Visible) { // fk_psd ?>
	<tr id="r_fk_psd">
		<td><span id="elh_party_skill_data_fk_psd"><?php echo $party_skill_data->fk_psd->FldCaption() ?></span></td>
		<td<?php echo $party_skill_data->fk_psd->CellAttributes() ?>>
<span id="el_party_skill_data_fk_psd" class="form-group">
<span<?php echo $party_skill_data->fk_psd->ViewAttributes() ?>>
<?php echo $party_skill_data->fk_psd->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($party_skill_data->skill_type->Visible) { // skill_type ?>
	<tr id="r_skill_type">
		<td><span id="elh_party_skill_data_skill_type"><?php echo $party_skill_data->skill_type->FldCaption() ?></span></td>
		<td<?php echo $party_skill_data->skill_type->CellAttributes() ?>>
<span id="el_party_skill_data_skill_type" class="form-group">
<span<?php echo $party_skill_data->skill_type->ViewAttributes() ?>>
<?php echo $party_skill_data->skill_type->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($party_skill_data->years_of_exp->Visible) { // years_of_exp ?>
	<tr id="r_years_of_exp">
		<td><span id="elh_party_skill_data_years_of_exp"><?php echo $party_skill_data->years_of_exp->FldCaption() ?></span></td>
		<td<?php echo $party_skill_data->years_of_exp->CellAttributes() ?>>
<span id="el_party_skill_data_years_of_exp" class="form-group">
<span<?php echo $party_skill_data->years_of_exp->ViewAttributes() ?>>
<?php echo $party_skill_data->years_of_exp->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($party_skill_data->rating->Visible) { // rating ?>
	<tr id="r_rating">
		<td><span id="elh_party_skill_data_rating"><?php echo $party_skill_data->rating->FldCaption() ?></span></td>
		<td<?php echo $party_skill_data->rating->CellAttributes() ?>>
<span id="el_party_skill_data_rating" class="form-group">
<span<?php echo $party_skill_data->rating->ViewAttributes() ?>>
<?php echo $party_skill_data->rating->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<script type="text/javascript">
fparty_skill_dataview.Init();
</script>
<?php
$party_skill_data_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$party_skill_data_view->Page_Terminate();
?>

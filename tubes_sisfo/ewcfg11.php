...
define("EW_PROJECT_ID", "{1F84AD9A-35E5-45ED-842B-365EF8643C81}", TRUE); // Project ID (GUID)
$EW_RELATED_PROJECT_ID = "";
$EW_RELATED_LANGUAGE_FOLDER = "";
define("EW_RANDOM_KEY", 'v1egtWhloYy6DkcI', TRUE); // Random key for encryption
...
define("EW_CONN_DB", 'sisfo_we', TRUE);
